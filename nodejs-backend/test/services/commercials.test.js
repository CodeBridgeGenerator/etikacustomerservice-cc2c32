...
describe("commercials service", () => {
  ...
  describe("#create", () => {
    const options = {"commercialCategory":"new value","customerName":"new value","contactNumber":23,"emailAddress":"new value","machineAddress":"new value","additionalDetail":"new value","rentOrPurchase":["new value"],"machineQuantity":23,"tenancyPeriod":1761195521868,"newOutlet":"new value","sellType":["new value"]};
